function tex_eig_pgftable(; label::String = "T:eigen", caption::String = "", name::String = "Eigenvalues", short_name = name)
    ...
    s *= "columns={num,real,imag,nfreq,zeta,tau,lambda}]{eigen.out}\n"
    s *= "\\end{footnotesize}\n"
    s *= "\\end{center}\n"
    s *= "\\end{table}\n\n"
