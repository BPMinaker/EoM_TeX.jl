...
The properties of the bodies are given in Tables~\ref{bodycoords} and~\ref{bodyinertia}.  The properties of the connections are given in Tables~\ref{pointcoords} and~\ref{connectcoords}.
...
every head row/.style={output empty row,
before row={\caption{Actuator Locations}\label{inputcoords}\\
\toprule No. & Actuator Name &
\multicolumn{6}{c}{Location [\si{\m}]} & \multicolumn{6}{c}{Location} &  \multicolumn{2}{c}{Gain}\\},
after row=\midrule}]{inputdata.out}
\end{footnotesize}
\end{center}
...
every head row/.style={output empty row,
before row={\caption{Sensor Locations}\label{outputcoords}\\
\toprule No. & Sensor Name &
\multicolumn{6}{c}{Location [\si{\m}]} & \multicolumn{6}{c}{Location} &  \multicolumn{2}{c}{Gain}\\},
after row=\midrule}]{outputdata.out}
\end{footnotesize}
\end{center}
