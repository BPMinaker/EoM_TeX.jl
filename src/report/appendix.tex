...
\[
\begin{bmatrix}
\mathbf{J}_\text{h} & {\bm 0} & {\bm 0}\\-{\mathbf J}_\text{h}{\mathbf V} & {\mathbf J}_\text{h} & {\bm 0}\\ {\bm 0} & {\mathbf J}_\text{nh} & {\bm 0}
\end{bmatrix}
\begin{bmatrix}
...
\pgfplotstabletypeset[sci,sci e,sci zerofill,precision=4,dec sep align,
every head row/.style={output empty row},
every last row/.style={after row={}},
write to macro=\A,
typeset=false]
{unformatted/dss/A.out}
\begin{tiny}
\[
{\mathbf A}=
\left[
...
\noindent The Jordan minimal state space equations:
\[
\begin{Bmatrix}
\dot{\bm x}\\ {\bm y}
\end{Bmatrix}
...
% columns/2/.style={sci,sci e,sci zerofill,precision=4,dec sep align,column name={Value}}]
